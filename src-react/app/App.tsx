...
import { useWindowEndingAlert } from "@/features/windows/useWindowEndingAlert";
import { useTraySync } from "@/features/tray/useTraySync";
...
import { getWeekBoundaries, isOnboardingCompleted, quitApp } from "@/shared/api/api";
