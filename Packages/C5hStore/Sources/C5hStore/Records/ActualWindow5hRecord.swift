...
struct ActualWindow5hRecord: Codable, FetchableRecord, PersistableRecord {
    static let databaseTableName = "actual_windows_5h"
    ...
    init(from window: ActualWindow5h) {
    ...
    func toActualWindow() throws -> ActualWindow5h {
        guard
            ...
            throw C5hError.databaseError("Invalid ActualWindow5hRecord: \(id)")
        }
